...
namespace OrchardCore.Media
{
    ...
    /// </summary>
    public class TenantPhysicalFileSystemCache : IImageCache
    {
        /// <summary>
        ...
        public TenantPhysicalFileSystemCache(IHostingEnvironment environment, MemoryAllocator memoryAllocator, IOptions<ImageSharpMiddlewareOptions> options)
        {
